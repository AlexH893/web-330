window.Arrow = function(window, document) {
    ...
    /* The rate the arrow increases opactiy */
    ...
    /* The rate the arrow decreases opactiy */
    ...
    function _applyStyleModern(node) {
        node.style.position = "fixed", node.style.zIndex = 999, node.style.display = "none", node.style.height = "309px", node.style.width = "186px", node.style.opacity = 0, node.style.backgroundImage = "url(https://i.ibb.co/8mvXgTX/arrow.png)", node.style.backgroundRepeat = "no-repeat", node.style.backgroundPositionX = "0", node.style.backgroundPositionY = "0"
    }
    ...
    function _applyStyleIE8(node) {
        ...
        var opacity = "progid:DXImageTransform.Microsoft.Alpha(opacity=0) ",
            imgSrc = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="https://ibb.co/Zf4NztN", sizingMethod="scale") ',
